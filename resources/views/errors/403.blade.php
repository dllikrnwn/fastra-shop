...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .code{font-family:'Space Grotesk',sans-serif;font-size:clamp(80px,15vw,180px);font-weight:900;line-height:1;color:#FF4444;text-shadow:4px 4px 0 #000}
        h2{font-family:'Space Grotesk',sans-serif;font-size:clamp(18px,4vw,28px);font-weight:900;margin-top:24px}
        p{color:#555;margin-top:8px;font-size:15px;max-width:400px;margin-left:auto;margin-right:auto;line-height:1.6}
...
<body>
    <div style="text-align:center">
        ...
        <h2>Akses Ditolak</h2>
        <p>Kamu tidak memiliki izin untuk mengakses halaman ini. Silakan login dengan akun yang sesuai.</p>
