...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        p{color:#555;margin-top:8px;font-size:15px;max-width:420px;margin-left:auto;margin-right:auto;line-height:1.6}
...
<body>
    <div style="text-align:center">
        ...
        <p>Server mengalami masalah. Tim kami sudah diberitahu. Silakan coba lagi beberapa saat.</p>
